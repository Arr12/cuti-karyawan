...
$tanggal=$_SESSION['MM_tanggal'];
$jam=$_SESSION['MM_jam'];
$tanggal_pengajuan=explode("-",$_SESSION['MM_tanggal']);
...
$query_rs_cuti = sprintf("SELECT * FROM t_cuti WHERE nomor_badge = '$no_budget' and tanggal_pengajuan='$tanggal_pengajuan_valid' and jam='$jam'");
...
<table width="1000" border="0" align="center">
  <tr>
    <td colspan="3"><strong>Desa Kepuharum </strong></td>
  </tr>
  <tr>
    <td colspan="3" align="center"><span class="style1">SURAT PERMOHONAN CUTI </span></td>
  </tr>
  <tr>
    <td colspan="3" align="center"><U><span class="style1">Karyawan Balai Desa Kepuharum</span></U></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="227">1. Nama </td>
    <td width="477">: <?php echo $row_rs_karyawan['nama_karyawan']; ?></td>
    <td width="282">NIK / Nomor Badge : <?php echo $row_rs_karyawan['nomor_badge']; ?></td>
  </tr>
  <tr>
    <td>2. Klasifikasi / Jabatan </td>
    <td>: <?php echo $row_rs_karyawan['klasifikasi']; ?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>3. Dept / Biro / Bagian / Unit </td>
    <td>: <?php echo $row_rs_karyawan['dep_biro_bagian']; ?> / <?php echo $row_rs_karyawan['bagian']; ?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>Kepuharum <?PHP echo "$tgl_sekarang"; ?> </td>
  </tr>
   <tr>
    <td align="left"></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><div align="center">1. ttd</div></td>
    <td><div align="center">2. ttd</div></td>
  </tr>
  <tr>
    <td height="21">1......................................................</td>
  ...
  <tr>
    <td colspan="3">Catatan Balai Desa Kepuharum </td>
  </tr>
   <tr>
 ...
 <tr>
    <td align="top" valign="top">2. Cuti telah diambil </td>
    <td> 
	<?php
mysql_select_db($database_cn_db_cuti_karywan, $cn_db_cuti_karywan);
...
$totalsekarang = array_sum($totalcuti);
  ...
  <tr>
    <td>- Cuti yang ke</td>
    <td>:  <?php 
			$jml_cuti=$totalRows_rs_cuti_lagi+1;
	echo $jml_cuti; ?></td>
    <td>Kepuharum, ....................................</td>
  </tr>
  <tr>
	...
	$tgl_gugur=$gugur[0]-1;
	$tglvalid_kerja_gugur=$tgl_gugur."-".$gugur[1]."-".$thn_gugur_new;
  ...
  <tr>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Adm. Desa Kepuharum </td>
    <td align="left">GM. SDM, Hukum, Umum & IT</td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Terhitung tanggal cuti sesuai pengajuan form kecil yang tulis oleh masing-masing tenaga tersebut </td>
  </tr>
</table>
</body>
</html>
